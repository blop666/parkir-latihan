            ...
            <div class="col-lg-8">
                ...
                <div class="card shadow-lg border-0 rounded-4">
                    <div class="card-header bg-gradient-dark text-white rounded-top-4">
                        <h5 class="mb-0 text-white">Location Input Form</h5>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="location_name" class="form-control" required
                                        placeholder="Gedung A B C">
                                </div>

                                <!-- Alamat (date sesuai validasi kamu) -->
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Max Motorcyle</label>
                                    <input type="integer" name="max_motorcycle" class="form-control" required
                                        placeholder="0">
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="integer" name="max_car" class="form-control" required placeholder="0">
                                </div>

                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Max Truck / Bus / Other</label>
                                    <input type="integer" name="max_other" class="form-control" required
                                        placeholder="0">
                                </div>
