<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html "
            target="_blank">
            <img src="{{ asset('parkir.png') }}" class="navbar-brand-img h-120" alt="main_logo">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link  @if ($title == 'Location') active @endif "
            ...
            <li class="nav-item">
                <a class="nav-link @if ($title == 'Transaction') active @endif "
            ...
            <li class="nav-item">
                <a class="nav-link @if ($title == 'vehicle_type') active @endif "
            ...
            {{-- <li class="nav-item">
          <a class="nav-link  @if ($title == 'Borrow')
              active
          @endif " href="{{ route('borrow.index') }}">
            ...
            {{-- <li class="nav-item">
                <a class="nav-link @if ($title == 'Distributor') active @endif "
          ...
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Account pages</h6>
            ...
            {{-- <li class="nav-item">
                <a class="nav-link @if ($title == 'Purchase') active @endif "
            ...
            {{-- <li class="nav-item">
                <a class="nav-link @if ($title == 'Borrow') active @endif "
            ...
            {{-- <li class="nav-item">
                <a class="nav-link @if ($title == 'Users') active @endif "
            ...
            {{-- <li class="nav-item">
          <a class="nav-link  " href="be/pages/sign-up.html">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
