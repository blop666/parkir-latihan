            ...
            <div class="col-lg-8">
                ...
                <div class="card shadow-lg border-0 rounded-4">
                    <div class="card-header bg-gradient-dark text-white rounded-top-4">
                        <h5 class="mb-0 text-white">Vehicle Type Input Form</h5>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="jenis" class="form-control" required>
                                        <option value="">-- Pilih Jeniss --</option>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="integer" name="perjam_pertama" class="form-control" required
                                        placeholder="0">
                                </div>

                                <!-- No Telpon -->
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Next Hour Charges</label>
                                    <input type="integer" name="perjam_berikutnya" class="form-control" required
                                        placeholder="0">
                                </div>

                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Max Cost Per Day</label>
                                    <input type="integer" name="max_perhari" class="form-control" required
                                        placeholder="0">
                                </div>
